        ...
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center justify-between h-16">
            <Link href="/" className="flex items-center gap-4">
              <AgentPulse size="small" color="indigo" />
          ...
          <div className="flex items-center gap-4">
            <SignedIn>
              <Link href="/manage-plan">
                <Button
                  variant="outline"
                  className="mr-4 bg-gradient-to-r from-indigo-600 to-indigo-400 text-transparent bg-clip-text border border-indigo-500 hover:border-indigo-800 hover:cursor-pointer hover:text-indigo-800"
                >
                  Manage Plan
                </Button>
              </Link>

              <div className="p-2 w-10 h-10 flex items-center justify-center rounded-full border border-indigo-300">
                <UserButton />
              </div>
            </SignedIn>
